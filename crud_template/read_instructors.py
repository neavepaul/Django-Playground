...
# GET
instructor_hudah = Instructor.objects.get(first_name="Hudah")
print("1. Find a single instructor with first name `Hudah`")
print(instructor_hudah)
...
full_time_instructors = Instructor.objects.exclude(full_time=False).filter(total_learners__gt=30000).\
        filter(first_name__startswith='N')
print("4. Find all full time instructors with First Name starts with `N` and learners count greater than 30000")
print(full_time_instructors)
print("\n")

# Same with FILTER
full_time_instructors = Instructor.objects.filter(full_time=True, total_learners__gt=30000,
                                                      first_name__startswith='N')
print("5. Find all full time instructors with First Name starts with `N` and learners count greater than 30000")
print(full_time_instructors)
